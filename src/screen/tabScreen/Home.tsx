  ...
  return (
    <View style={{ backgroundColor: 'white', flex: 1 }}>
      <ScrollView nestedScrollEnabled={true} contentContainerStyle={{ backgroundColor: 'white' }}>
        ...
        <CustomSearchbar />
        <Text style={{ marginStart: 16, marginTop: 10, fontSize: 16, fontWeight: '700', color: '#1D71D4', fontFamily: 'Karla' }}>
          My Activity
        </Text>
        <FlatList
          data={data}
        ...
        <FlatList
          ...
          keyExtractor={(_item, index) => index.toString()}
          contentContainerStyle={{ padding: 5 }} />
        <TouchableOpacity style={{ marginTop: -10, marginStart: 23 }}>
          <Text style={{ color: '#1D71D4', fontFamily: 'Karla', fontStyle: 'normal', fontWeight: '700', fontSize: 12 }}>
            More
            <Image source={require("../../../src/assests/images/rightArrow.png")} style={{ resizeMode: 'contain', width: 20, height: 13, tintColor: "#1D71D4" }} />
          </Text>
        </TouchableOpacity>
        <TouchableOpacity style={{ backgroundColor: "#C7DDF6", height: 55, elevation:3,width: 55, alignSelf: 'flex-end' , marginBottom:40 , alignItems:'center', marginEnd:18 , borderRadius:30}}>
          <Image
